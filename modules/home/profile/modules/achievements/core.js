...
function grabValues() {
    ...
    then(result => {
        ...
        if(result.response.status == true){
            const errorRef = document.getElementById('er')
            errorRef.innerHTML = `<p class="alert alert-success">Successfully Added</p>`
            setTimeout(function(){
                errorRef.innerHTML = ``
            },3000)
        }
            ...
            const errorRef = document.getElementById('er')
            errorRef.innerHTML = `<p class="alert alert-danger">Something Went Wrong</p>`
            setTimeout(function(){
                errorRef.innerHTML = ``
            },3000)
        }
